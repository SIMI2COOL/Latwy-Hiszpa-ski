  ...
  const categories: Category[] = [
    {
      ...
      titlePolish: 'LUDZIE',
      titleSpanish: 'GENTE',
      description: 'Cuerpo, cara, familia',
      icon: '👥',
      color: '#3B82F6',
      subcategories: [],
      totalWords: 0,
    ...
    },
    {
      ...
      titlePolish: 'ZDROWIE',
      titleSpanish: 'SALUD',
      description: 'Enfermedades, médico, hospital, farmacia',
      icon: '🏥',
      color: '#EF4444',
      subcategories: [],
      totalWords: 0,
    ...
    },
    {
      ...
      description: 'Emergencias, banco, correo, hotel',
      icon: '🔧',
      color: '#10B981',
      subcategories: [],
      totalWords: 0,
    ...
    },
    {
      ...
      description: 'Teatro, cine, música, lectura',
      icon: '🎭',
      color: '#A855F7',
      subcategories: [],
      totalWords: 0,
    },
    {
      ...
      description: 'Espacio, tierra, animales, plantas',
      icon: '🌍',
      color: '#059669',
      subcategories: [],
      totalWords: 0,
