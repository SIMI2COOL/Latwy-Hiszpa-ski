...
function ProgressPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 pb-24 md:pb-8">
      <h1 className="text-3xl font-bold text-gray-900 mb-8">Twój postęp</h1>

      {/* Level Card */}
      <div className="card p-8 mb-6 text-white" style={{ background: 'linear-gradient(to bottom right, #0074bd, #004470)' }}>
        <div className="flex items-center justify-between mb-6">
          <div>
            <div className="text-sm opacity-90 mb-1">Obecny poziom</div>
        ...
        <div className="space-y-2">
          <div className="flex items-center justify-between text-sm">
            <span>Postęp do poziomu {progress.level + 1}</span>
      ...
      <div className="card p-6">
        ...
        {recentSessions.length > 0 ? (
          ...
          <div className="text-center py-8 text-gray-500">
            ...
            <p>Brak sesji nauki. Zacznij uczyć się, aby zobaczyć tutaj swoją aktywność!</p>
          </div>
        )}
      </div>
        ...
        <div className="flex items-start space-x-4">
          ...
          <div>
            ...
            <p className="text-gray-700">
              {progress.streak > 0
                ? `Uczyłeś się ${progress.streak} dni z rzędu. Nie przerywaj serii!`
                : 'Zacznij swoją dzienną serię nauki już dziś.'}
            </p>
          </div>
        </div>
      </div>
